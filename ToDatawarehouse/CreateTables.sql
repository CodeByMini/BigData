...
DROP TABLE TempAlertTable
DROP TABLE SensorTypeTable
...
CREATE TABLE TempAlertTable (
	Id bigint not null identity(1,1) PRIMARY KEY,
	TempAlert nvarchar(20) not null
)
GO
...
CREATE TABLE MeasurmentTable (
	...
	TempAlertId bigint not null references TempAlertTable(Id),
	Temp float,
	Humidity float
